...
import (
	...
	appv1alpha1 "operator-sdk-demo/pkg/apis/app/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appv1alpha1.Demo{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *appv1alpha1.Demo) *corev1.Pod {
